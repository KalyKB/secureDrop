...
form.addEventListener("submit", async (e) => {
  ...
  if (firstname_input !== null) {
    ...
    const response = await fetch("https://securedrop-production.up.railway.app/api/auth/register", {
      method: "POST",
      headers: {
    ...
    const response = await fetch("https://securedrop-production.up.railway.app/api/auth/login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
